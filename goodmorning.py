...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        weather_api_link_dark = "https://api.darksky.net/forecast/c0ab99fade4c790cf3ef32793717e258/44.4396,26.0963"
        weather_api_link_accu = "http://dataservice.accuweather.com/currentconditions/v1/287430?apikey=38bxD1HVNopdZbBpXGANYAwKsAewiucN"
        
        try:
            bucharest = http_get(weather_api_link_accu)
            celsius = round(bucharest[0]['Temperature']['Metric']['Value'])
            temperature = "The temperature outside is {} degrees. ".format(celsius)

        except:
            bucharest = http_get(weather_api_link_dark)
                                ...
                                RenderDocumentDirective(
                                    ...
                                    datasources={
                                        "bodyTemplate6Data": {
                                            ...
                                            "logoUrl": "https://yakkie.app/wp-content/uploads/2019/09/sun-transparent.png",
