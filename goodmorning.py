...
class LaunchRequestHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        price_api_link = "https://min-api.cryptocompare.com/data/price?fsym=BTC&tsyms=USD&api_key=4ca8ca1f2f7499823cde74ea2212edbd64d972f770b8d28708224065f262bf46"
        ...
        speech = "<speak><amazon:effect name='whispered'>" + hi + "<break time='0.25s'/>" + time + "<break time='0.25s'/>" + price + "<break time='0.25s'/>" + bye + "</amazon:effect></speak>"
                                    ...
                                    datasources={
                                        "bodyTemplate6Data": {
                                            ...
                                            "textContent": {
                                                ...
                                                "secondaryText": {
                                                    "type": "PlainText",
                                                    "text": str('%.f' % list(price_api_result.values())[0]) + " BTC/USD"
                                                }
                                            },
                                            "logoUrl": "",
